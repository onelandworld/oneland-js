...
export class SandboxLandAbi__factory {
  static readonly abi = _abi;
  static createInterface(): SandboxLandAbiInterface {
    return new utils.Interface(_abi) as SandboxLandAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SandboxLandAbi {
    return new Contract(address, _abi, signerOrProvider) as SandboxLandAbi;
  }
}
