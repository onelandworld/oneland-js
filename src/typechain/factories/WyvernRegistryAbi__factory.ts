...
import type {
  WyvernRegistryAbi,
  WyvernRegistryAbiInterface,
} from "../WyvernRegistryAbi";
...
export class WyvernRegistryAbi__factory {
  static readonly abi = _abi;
  static createInterface(): WyvernRegistryAbiInterface {
    return new utils.Interface(_abi) as WyvernRegistryAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): WyvernRegistryAbi {
    return new Contract(address, _abi, signerOrProvider) as WyvernRegistryAbi;
  }
}
